...
<head>
    ...
    <title>Forgot passwordAdmin</title>
...
header('Location: readforgotpasswordAdmin.php');
$data = $_POST['data'];

$q = "SELECT * FROM admin WHERE email= '$data'" ;
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalCenterTitle">Change Admin Password</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <form action="change-forgotpasswordAdmin.php" method="post">
