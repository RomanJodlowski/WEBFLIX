    ...
    frameborder = "0" allow = "accelerometer; 
     ...
     picture-in-picture"   allowfullscreen >
	     ...
	     ';
                        ...
                        echo '<h1>The video is permitted for fully subscribed users only</h1>';
                        echo '<br>';
                        echo '<h3>Buy your subscription now!</h3>';
                        echo '<br>';
                        echo '<a href="paypal.php" type="button" class="btn btn-outline-warning btn-lg">Subscription</a>';
                    }
                }
            }
